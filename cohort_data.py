...
def unique_houses(filename):
    ...
    for line in cohort_file:
        first_name, last_name, house, advisor, cohort = line.split("|")
        if house != '':
            houses.add(house)
...
def hogwarts_by_house(filename):
    ...
    for line in cohort_file:
        line = line.rstrip()
        first_name, name, house, advisor, cohort = line.split("|")
    ...
    #all_hogwarts = [sorted(lst) for lst in all_hogwarts]
...
def all_students_tuple_list(filename):
    ...
    for line in cohort_file:
        ...
        if cohort != 'G' and cohort != 'I':
            ...
            student_data =(name, house, advisor, cohort)
...
def find_cohort_by_student_name(student_list):
    ...
    # Code goes here
    question = input("Enter student first and last names: ").title()
    for tupl in student_list:
        if question in tupl:
            print ("{} was in the {} cohort".format(question, tupl[3]))
        else:
